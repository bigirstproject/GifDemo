...
public class GifImageButton extends ImageButton {
     ...
     *
     * @param context
     * @see android.widget.ImageButton#ImageButton(android.content.Context)
     */
     ...
     * @param context
     * @param attrs
     * @see android.widget.ImageButton#ImageButton(android.content.Context, android.util.AttributeSet)
     */
     ...
     * @param attrs
     * @param defStyle
     * @see android.widget.ImageButton#ImageButton(android.content.Context, android.util.AttributeSet, int)
     */
     ...
     * @param defStyle
     * @param defStyleRes
     * @see android.widget.ImageButton#ImageButton(android.content.Context, android.util.AttributeSet, int, int)
     */
