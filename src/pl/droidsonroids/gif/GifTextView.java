...
/**
 * A {@link android.widget.TextView} which handles GIFs as compound drawables. NOTE:
...
public class GifTextView extends TextView {
     ...
     * @param defStyle
     * @param defStyleRes
     * @see android.widget.TextView#TextView(android.content.Context, android.util.AttributeSet, int, int)
     */
