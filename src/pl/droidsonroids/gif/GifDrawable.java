...
public class GifDrawable extends Drawable implements Animatable, MediaPlayerControl {
     ...
     *
     * @return current error or {@link pl.droidsonroids.gif.GifError#NO_ERROR} if there was no error or drawable is recycled
     */
     ...
     * Note: If animation is in progress ({@link #draw(android.graphics.Canvas)}) was already called)
     ...
     * For GifDrawables constructed from {@link java.io.InputStream} and {@link java.io.FileDescriptor} -1 is always returned.
     * In case of {@link java.io.File}, file path, byte array and {@link java.nio.ByteBuffer} length is always known.
     *
    ...
    /**
     * Returns in pixels[] a copy of the data in the current frame. Each value is a packed int representing a {@link android.graphics.Color}.
     *
